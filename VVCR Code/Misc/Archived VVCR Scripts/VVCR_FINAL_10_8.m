function [ AVG_Pes, AVG_Pmax, VVCR_UT, VVCR_KH, Pnam, Pmrn, file, numPeaks, STD_Pes, STD_PMX] = VVCR_FINAL_10_6( PathName, FileName)

% apply loadp function to load the data into matlab variables
[Pres, dPdt, ~, Pnam, Pmrn, file, ~, ~]=loadp(PathName,FileName,100);
