...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%LEGACY%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    dPmaxIdx = NoPeaksRet.Ext.dPmaxIdx;
    dPmaxVal = NoPeaksRet.Ext.dPmaxVal;

    dPminIdx = NoPeaksRet.Ext.dPminIdx;
    dPminVal = NoPeaksRet.Ext.dPminVal;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%LEGACY%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[DatRet1, DatRet2] = data_isoseg (false, Data, ivIdx);

isoFitPts.iv1Pres = DatRet1.P;
isoFitPts.iv1Time = DatRet1.T;
iv1PsIdx_Doub = DatRet2.i1d;
iv1NeIdx_Doub = DatRet2.i2d;
ivIdx.Ps1_D = DatRet2.i1d;
ivIdx.Ne1_D = DatRet2.i2d;
...
% BE UPDATED AS IT FINDS BAD FITS... PUT totIso*Points in FitStr.Plot.
FitStr.Data  = Data;
FitStr.ivIdx = ivIdx;
FitStr.ivVal = ivVal;
FitStr.ivSeg = DatRet1; % CLEAN THIS UP ONCE data_isoseg IS REVISED
FitStr.Plot  = [];      % PLACEHOLDER
...
FitStr.iv1PsVal = iv1PsVal;

% Time of EDP, neg EDP occured; used for buttondownFcn
FitStr.iv1PsIdx_D = iv1PsIdx_Doub;
FitStr.iv1NeIdx_D = iv1NeIdx_Doub;
