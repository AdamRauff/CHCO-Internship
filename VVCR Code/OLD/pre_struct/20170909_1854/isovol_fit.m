function [RetVal] = isovol_fit (isoFitPts, timeDoub, PresDoub, ICS)
%
% isoFitPts  - Struct of all pres and time fitting values:
...
iv1Pres = isoFitPts.iv1Pres;
iv1Time = isoFitPts.iv1Time; 
% Values for Kind fit; note that Pres actually contains P and dP/dt values.
%iv2Pres = isoFitPts.iv2Pres;
%iv2Time = isoFitPts.iv2Time; 
...
RetVal.iv1Time_D = iv1Time;          % Fitting Points
RetVal.iv1Pres_D = iv1Pres;
