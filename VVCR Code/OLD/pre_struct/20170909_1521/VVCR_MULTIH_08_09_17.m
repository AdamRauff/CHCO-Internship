...
[DatRet] = data_isoseg (iv1PsIdx, iv1NeIdx, time, timeDoub, PresDoub, ...
                       dPmaxIdx, dPminIdx, false, Data, ivIdx);
isoFitPts.iv1Pres = DatRet.P;
isoFitPts.iv1Time = DatRet.T;
iv1PsIdx_Doub = DatRet.i1d;
iv1NeIdx_Doub = DatRet.i2d;
...
FitStr.ivIdx = ivIdx;
FitStr.ivVal = ivVal;
FitStr.ivSeg = DatRet; % CLEAN THIS UP ONCE data_isoseg IS REVISED
