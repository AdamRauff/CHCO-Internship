function [ AVG_Pes, AVG_Pmax, VVCR_UT, VVCR_KH, Pnam, Pmrn, file ] = VVCR_FINAL( PathName, FileName)
...
% pre-allocate structure
PeakStruct = struct('Data',cell(2,1), 'ivt',cell(2,1), 'iv', cell(2,1), 'isoPts', cell(2,1), 'Cs', cell(2,1), 'Misc', cell(2,1), 'EDPs', cell(2,1));
...
PeakStruct(1).EDPs = EDP_T; % give the time EDP occured - used for buttondownFcn
PeakStruct(2).EDPs = EDP_NT; % give the time negative EDP occured - used for buttondownFcn
