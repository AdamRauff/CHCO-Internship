function [Ret1, Ret2] = test_fit_kind (ivSeg, ivIdx, Data, WgtFlg)
%
...
for i = 1:nfits
    ...
    % didn't do this from the start, D'OH! This is now constant even if the
    % pos iso phase starts at different times.
    zero = Data.Tst;
    oldzero = Data.Time_D(ivSeg.iv2Time(i).PosIso(1));
